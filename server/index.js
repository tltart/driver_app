...
setInterval(() => {
    if (ro) {
        mass2 = [...mass, 
            { ...mass[7].currentLocationLatitude = parseFloat(mass[7].currentLocationLatitude) + po}, 
            { ...mass[7].currentLocationLongitude = parseFloat(mass[7].currentLocationLongitude) + po },
            // {...mass[7].activeStatus = 1}
        ]
        ro = !ro;
    }
    else {
